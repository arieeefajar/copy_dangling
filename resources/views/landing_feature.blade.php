...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/landing_feature/assets/favicon.ico" />
    <!-- Bootstrap icons-->
    ...
    <link href="/landing_feature/css/styles.css" rel="stylesheet" />
</head>
...
<body id="page-top">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <a class="me-lg-3 mb-4 mb-lg-0" href="#!"><img class="app-badge"
                                    src="/landing_feature/assets/img/google-play-badge.svg" alt="..." /></a>
                            <a href="#!"><img class="app-badge"
                                    src="/landing_feature/assets/img/app-store-badge.svg" alt="..." /></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                <div class="screen bg-black">
                                    ...
                                    <video muted="muted" autoplay="" loop=""
                                        ...
                                        <source src="/landing_feature/assets/img/demo-screen.mp4" type="video/mp4" />
                                    </video>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8">
                    ...
                    <img src="/landing_feature/assets/img/tnw-logo.svg" alt="..." style="height: 3rem" />
                </div>
            </div>
        </div>
    </aside>
    ...
    <section class="bg-gradient-primary-to-secondary" id="download">
        <div class="container px-5">
            ...
            <div class="d-flex flex-column flex-lg-row align-items-center justify-content-center">
                <a class="me-lg-3 mb-4 mb-lg-0" href="#!"><img class="app-badge"
                        src="/landing_feature/assets/img/google-play-badge.svg" alt="..." /></a>
                <a href="#!"><img class="app-badge" src="/landing_feature/assets/img/app-store-badge.svg"
                        alt="..." /></a>
            </div>
        </div>
    </section>
    ...
    <!-- Core theme JS-->
    <script src="/landing_feature/js/scripts.js"></script>
    <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
    <!-- * *                               SB Forms JS                               * *-->
